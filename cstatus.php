...
$other=$getrow['oname'];
	...
	echo "$other";
	echo "&nbsp";
	echo "your Booking is Still Active.";
	echo "<br>";
	...
	echo "</div>";
				...
				{
	echo "<div class=error-message>Sorry, No result found for this Application ID...</div>";
				

				}
}
?>
						<h2><b>Check Your Booking Status</b></h2>
						<div id="contact_form">
							<form name="form1" id="ff" method="post" action="cstatus.php">
								<label>
